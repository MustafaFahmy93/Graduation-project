...
#44444444444444444444444444
            ...
            cv2.imwrite("wrapcolor2.jpg", newwarp)
            ...
            cv2.imwrite("wrapcolor.jpg", left_right_fill )
...
dim = (192, 320)
# resize image
image = cv2.resize(images, dim, interpolation=cv2.INTER_AREA)


print("oo")
# show the frame
# lines.project_on_road_debug(image)
#cv2.imshow("yasmin",image)
im=lines.project_on_road_debug(image)
print("oo")
